<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="/logangadmin/{{$listingadmin->id}}/update" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="mb-6">
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="TipeMagang" placeholder="{{$listingadmin->TipeMagang}}"/>
      </div>
      ...
      <div class="mb-6">
        ...
        <a href="/logangadmin" class="text-black ml-4"> Back </a>
      </div>
    </form>
  </x-card>
</x-layout>
