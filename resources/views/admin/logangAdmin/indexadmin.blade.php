<x-layout>
  ...
  <div class="mb-6 ml-5">
    ...
    <button class="bg-laravel text-white rounded py-2 px-2 hover:bg-white">
      <a href="/manageLogangAdmin" class="hover:text-laravel"><i class="fa-solid fa-gear"></i> Manage Lowongan </a>
    </button>
  </div>
  ...
  <div style="display: flex; justify-content: space-between;">
    ...
    <div style="width: 60%;">
      <div class="p-2.5">
        @unless(count($listingmagangadmin) == 0)

        @foreach($listingmagangadmin as $listing)
    ...
    <div style="width: 35%;">
      <form id="filterForm" method="GET" action="{{ route('listingmagangadmin.index') }}">
          <!-- Pengalaman Kerja -->
