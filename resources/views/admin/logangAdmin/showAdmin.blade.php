      ...
      <div class="flex flex-col items-center justify-center text-center">
        ...
        <div>
          ...
          <div class="text-lg space-y-6">
            ...
            <a href="mailto:{{$listingmagang->Email}}" style="color: inherit; text-decoration: none;" class="block bg-blue-700 text-white mt-6 py-2 px-40 rounded-xl hover:bg-blue-800">
              <i class="fa-solid fa-envelope"></i>
              Contact Employer
            </a>

            <a href="{{$listingmagang->Website}}" target="_blank" style="color: inherit; text-decoration: none;" class="block bg-blue-700 text-white py-2 px-40 rounded-xl hover:bg-blue-800">
