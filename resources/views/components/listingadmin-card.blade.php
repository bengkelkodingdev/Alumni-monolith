  ...
  <div>
    <div style="display: flex; align-items: center; border: 1px solid #d1d5db; border-radius: 0.5rem; padding: 1rem; background-color: white; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05);">
      ...
      <div style="flex-grow: 1;">
        <h3 style="font-size: 1.25rem; font-weight: 600; margin-bottom: 0.25rem;">
          <button type="button" style="background: none; border: none; color: inherit; text-decoration: none; padding: 0; cursor: pointer;"
            data-bs-toggle="modal" data-bs-target="#dialogShowLokerAdmin" data-id="{{ $listing->id }}" data-bs-remote="{{ route('lokeradmin.showAdmin', $listing->id) }}">
            <b>{{ $listing->Posisi }}</b>
          </button>
        </h3>
        <div style="color: #4b5563; margin-bottom: 0.5rem;">{{ $listing->NamaPerusahaan }}</div>
        <x-listingadmin-tags :tagsCsv="$listing->Tags" />
      ...
      <div style="display: flex; flex-direction: column; align-items: flex-end;">
        <span style="background-color: #d1fae5; color: #065f46; font-size: 0.75rem; font-weight: 600; margin-right: 0.25rem; 
              padding: 0.25rem 1rem; border-radius: 0.5rem; width: 8rem; text-align: center; margin-bottom: 0.5rem;">
              {{ $listing->TipeKerja }}
        </span>
        <span style="background-color: #fecaca; color: #991b1b; font-size: 0.75rem; font-weight: 600; margin-right: 0.25rem; 
...
<div class="job-listings-container" style="margin-bottom: 1.25rem; margin-left: 0.5rem; flex: 1; display: flex;">
  <div style="display: flex; align-items: center; flex: 1; border: 1px solid #d1d5db; border-radius: 0.5rem; padding: 1rem; background-color: white; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05);">
