...
<nav class="sb-topnav navbar navbar-expand">
    ...
    <form action="{{ route('loker.manage') }}"  class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
...
<div class="mb-6 ml-5">
    <a href="{{ route('loker.index') }}"  class="btn btn-primary text-white px-3 py-2 rounded-5" style="width: 100px; text-align: center;">
              ...
              <tbody>
                  @forelse ($loker as $lkr)
                      <tr>
                        ...
                        <td class="px-4 py-8 border-t border-b border-gray-300 text-lg centered-column">
                            <form method="POST" action="{{ route('loker.delete', ['id' => $lkr->id]) }}" onsubmit="return confirm('Delete?')">
                                @csrf
                                @method('DELETE')
