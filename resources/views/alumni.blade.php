    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 mb-4">
                <a href="profil_admin.html" class="menu-box">
                    <i class="fas fa-user menu-icon"></i>
                    <h2 class="menu-title">Profil Alumni</h2>
                    <p class="menu-description">Lihat dan kelola profil alumni Anda.</p>
                </a>
            </div>
            <div class="col-md-6 mb-4">
                <a href="{{ route('tracerstudy.check') }}" class="menu-box">
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <a href="{{ route('listingmagang.index') }}" class="menu-box">
                    ...
                    <p class="menu-description">Cari program magang untuk mengembangkan pengalaman Anda.</p>
                </a>
            </div>
            <div class="col-md-6 mb-4">
